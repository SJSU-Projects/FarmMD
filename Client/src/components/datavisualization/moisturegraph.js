...
function mapStateToProps(state){
  ...
  if (data) {
    ...
    sensorData = [
      data.rows[n - 7].doc.data.moisture,
      data.rows[n - 100].doc.data.moisture,
      data.rows[n - 200].doc.data.moisture,
      data.rows[n - 500].doc.data.moisture,
      data.rows[n - 1000].doc.data.moisture,
      data.rows[n - 1200].doc.data.moisture,
      data.rows[n - 1100].doc.data.moisture,
    ];
  }
...
export default connect(mapStateToProps, actions)(MoistureGraph);
